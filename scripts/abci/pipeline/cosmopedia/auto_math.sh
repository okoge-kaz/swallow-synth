...
INPUT_FILE_PATH="/groups/gag51395/datasets/raw/pretrain/cosmopedia/data/auto_math_text-jsonl/train-${INDEX}-of-00018.jsonl"
OUTPUT_DIR="/groups/gag51395/datasets/raw/pretrain/swallow-cosmopedia/auto_math_text"
mkdir -p $OUTPUT_DIR
...
uv run python src/cosmopedia_automath_pipeline.py \
