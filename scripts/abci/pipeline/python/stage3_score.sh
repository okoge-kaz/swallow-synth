...
if [ -z "$INDEX" ]; then
  ...
  echo "Usage: qsub -v INDEX=0002 stage3_score.sh"
  exit 1
fi
...
INPUT_FILE_PATH="/groups/gag51395/datasets/raw/pretrain/swallow-code-v2/stage2/python/train_${INDEX}_without_errors.jsonl"
