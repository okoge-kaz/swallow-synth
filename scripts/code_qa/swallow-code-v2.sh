...
DATASET_DIR=/groups/gch51639/fujii/datasets/raw/pretrain/swallow/swallow-code-v2-dev/qa/python/medium_quality/Qwen3-30B-A3B-Instruct-2507-FP8/conversation
INPUT_FILE_PATH="$DATASET_DIR/train_${INDEX}.jsonl"
